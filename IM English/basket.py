...
def print_basket():
    ...
    pdf.cell(200, 10, txt="Order Offer", ln=True, align="C")
    pdf.ln(10)

    pdf.set_font("DejaVu", size=12)
    pdf.cell(110, 10, txt="Product Name", border=1, align="C")
    pdf.cell(30, 10, txt="Unit Price", border=1, align="C")
    pdf.cell(20, 10, txt="Amount", border=1, align="C")
    pdf.cell(30, 10, txt="Total Price", border=1, align="C")
    pdf.ln(10)
    ...
    directory = os.path.join(os.path.dirname(__file__), "Offers")
    if not os.path.exists(directory):
        os.makedirs(directory)
    filename = f"offer-{order_number}.pdf"
